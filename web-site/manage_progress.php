	...
	<form action="" id="manage-progress">
		...
		<div class="col-lg-12">
			<div class="row">
				<div class="col-md-5">
					<?php if(!isset($_GET['tid'])): ?>
					 <div class="form-group">
		              <label for="" class="control-label">Задача проекта</label>
					...
					<div class="form-group">
						<label for="">Начало времени</label>
				...
				<div class="col-md-7">
					<div class="form-group">
						<label for="">Комментарий/Описание хода выполнения</label>
