                ...
                $row['status'] = 4;
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <br>
                          <small>
                           Должный: <?php echo date("Y-m-d",strtotime($row['end_date'])) ?>
                          </small>
                      </td>
                      ...
                      <td class="project-state">
                          <?php echo "<span class='badge badge-" . ($row['status'] >= 0 && $row['status'] < count($stat) ? 'primary' : 'secondary') . "'>" . (isset($stat[$row['status']]) ? $stat[$row['status']] : 'Неизвестный статус') . "</span>"; ?>
                      </td>
                      <td>
