<head>
  ...
  <?php 
  date_default_timezone_set("ru");
  
  ob_start();
  // Ассоциативный массив английских и русских названий страниц
  $page_titles = array(
      ...
      'view_project' => 'Активный проект',
      'edit_project' => 'Редактировать проект',
      'edit_user' => 'Редактировать пользователя',
      // Добавьте другие страницы здесь
  );
  
  // Получение английского названия страницы из параметра 'page' в URL
  $page = isset($_GET['page']) ? $_GET['page'] : 'home';
  
  // Получение русского названия страницы из массива по английскому названию
  $title = isset($page_titles[$page]) ? $page_titles[$page] : 'Главная страница';
  ?>
